    ...
    <el-row v-for="item in data" :key="item.id" :gutter="0"
        ...
        <el-col :span="18">
            ...
            <el-row>
                <el-col :span="4">
                    <el-row>
                        <img src="//s1.hdslb.com/bfs/static/jinkela/video/asserts/view.svg" alt="">{{item.view}}
                    </el-row>
                </el-col>
                <el-col :span="4">
                    <el-row>
                        <img src="//s1.hdslb.com/bfs/static/jinkela/video/asserts/dm.svg" alt="">{{item.reply}}
                    </el-row>
                </el-col>
                <el-col :span="4">
                    <el-row>
