...
class Mysql_csv(object):
    ...
    def __init__(self):
        # 读取数据库和建立游标对象
        self.connect = pymysql.connect(host=MYSQL_HOST, port=MYSQL_PORT, user=MYSQL_USER, password=MYSQL_PASSWD,
                                       database=MYSQL_DB,
                                       charset="UTF8MB4")
    ...
    def create(self):
        ...
        create_tieba = """"""
        sql1 = "create table if not exists tieba(id INT not null,`rank` INT not null,title varchar(255) not null,link varchar(255) not null,image_url varchar(255) not null,`describe` text not null,heat varchar(50) not null,`date` varchar(50) not null,primary key(`rank`,`date`))default charset=UTF8MB4;"
        sql2 = "create table if not exists zhihu(id INT not null,`rank` INT not null,title varchar(255) not null,link varchar(255) not null,image_url varchar(255) not null,`describe` text not null,heat varchar(50) not null,`date` varchar(50) not null,primary key(`rank`,`date`))default charset=UTF8MB4;"
        sql3 = "create table if not exists weibo(id INT not null,`rank` INT not null,title varchar(255) not null,link varchar(255) not null,`date` varchar(50) not null,primary key(id,`date`))default charset=UTF8MB4;"
        ...
        sql4 = "create table if not exists bilibili(id INT not null,`rank` INT not null,title varchar(255) not null,`link` varchar(255) not null,`image_url` varchar(255) not null,`describe` text not null,`author` varchar(255) not null,view varchar(10) not null,`like` varchar(10) not null,`reply` varchar(10) not null,`favorite` varchar(10) not null,`coin` varchar(10) not null,`share` varchar(10) not null,`date` varchar(50) not null,primary key(`rank`,`date`))default charset=UTF8MB4;"
